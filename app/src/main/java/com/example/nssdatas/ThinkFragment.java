...
import com.example.nssdatas.Adapter.ThinkRecyclerAdapter;
...
public class ThinkFragment extends Fragment {
    ...
    ArrayList<ThankModel> thinkList= new ArrayList<ThankModel>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView=inflater.inflate(R.layout.fragment_think,container,false);
        recycle = (RecyclerView) rootView.findViewById(R.id.think_recycle_view);
        return rootView;
    }
    ...
    private void showDatas() {
        ...
        Log.d("GettingDatas",Integer.toString(thinkList.size()));
    }
